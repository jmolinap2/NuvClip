...
String userMessageFor(DownloadErrorCode code) => switch (code) {
      ...
      DownloadErrorCode.extractorOutdated => 'La plataforma cambio algo que todavia no se puede procesar. Ya se intento actualizar el extractor automaticamente; intenta de nuevo mas tarde.',
